...
log4js.configure(
{
    ...
    [  
        ...
        {  
            "category":"center",  
            "type": "file",  
            "filename": __dirname + "/../../logs/center.log",  
            "maxLogSize": 104800,
            "encoding": 'utf-8',  
            "backups": 10  
        },
        {  
            "category":"operate",  
            "type": "file",  
            "filename": __dirname + "/../../logs/operate.log",  
            "maxLogSize": 104800,
            "encoding": 'utf-8',  
            "backups": 10  
        },
        {  
            "category":"account",  
            "type": "file",  
            "filename": __dirname + "/../../logs/account.log",  
            "maxLogSize": 104800,
            "encoding": 'utf-8',  
            "backups": 10  
        } 
...
/*
   replaceConsole 是替换console打印的 
*/
//var logger = log4js.getLogger(name);
//logger.setLevel('INFO');
// app.use( log4js.connectLogger( this.logger('normal'), {level:'auto', format:':method :url'}));

exports.getLogger = function( name, param )
{
    var logger = log4js.getLogger( name );
    if( param && param.levels )
    {
        //logger.setLevel('INFO');
        logger.setLevel( param.levels );
    }
    return logger;
};
